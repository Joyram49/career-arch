...
exports.getMe = getMe;
const OrgAuthService = __importStar(require("@services/org.auth.service"));
const apiResponse_1 = require("@utils/apiResponse");
const constants_1 = require("@utils/constants");
async function register(req, res) {
    const result = await OrgAuthService.registerOrg(req.body);
...
async function getMe(req, res) {
    ...
    return (0, apiResponse_1.sendSuccess)(res, { organization }, 'Organization profile retrieved');
}
//# sourceMappingURL=org.auth.controller.js.map