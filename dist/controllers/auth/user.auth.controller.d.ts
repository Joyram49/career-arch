...
export declare function resendVerification(req: Request, res: Response): Promise<Response>;
...
export declare function disableTwoFa(req: Request, res: Response): Promise<Response>;
