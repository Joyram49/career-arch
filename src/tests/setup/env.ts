...
process.env['BREVO_API_KEY'] = process.env['BREVO_API_KEY'] ?? 'BV.test-key';
process.env['BREVO_API_USER'] = process.env['BREVO_API_USER'] ?? 'BV.test-user';
...
process.env['LINKEDIN_CLIENT_ID'] = process.env['LINKEDIN_CLIENT_ID'] ?? 'test';
process.env['LINKEDIN_CLIENT_SECRET'] = process.env['LINKEDIN_CLIENT_SECRET'] ?? 'test';
